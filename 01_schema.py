# Dome Process Analyzer — Core Pydantic Schema
# Carry this into Claude Code as the data model foundation.
...
class GovernanceFlag(BaseModel):
    ...
    category: str
    # Known categories:
    # "segregation_of_duties", "audit_trail", "approval_threshold",
    # "data_retention", "regulatory_compliance", "single_point_of_failure",
    # "shadow_it", "double_pledge"
    title: str
    description: str
...
class AutomationOpportunity(BaseModel):
    ...
    automation_type: str
    # Known types:
    # "rpa", "ai_extraction", "api_integration",
    # "workflow_engine", "llm_agent", "rule_engine"
