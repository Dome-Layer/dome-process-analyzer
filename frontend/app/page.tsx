    ...
    <div className="flex-1 bg-dome-bg-primary">
      <main className="max-w-[1152px] mx-auto px-6 md:px-8 py-12 md:py-16">
        ...
        <div className="mb-10">
          ...
          <h1 className="font-sans text-3xl md:text-4xl font-bold text-dome-text-primary tracking-dome-tight leading-tight mb-3">
            Map, govern, and automate
          </h1>
          <p className="font-sans text-base text-dome-text-secondary max-w-xl leading-relaxed">
        ...
        {/* Input form */}
        {!analysis && (
          <div className="bg-dome-bg-secondary border border-dome-border rounded-dome-card p-6 mb-8">
